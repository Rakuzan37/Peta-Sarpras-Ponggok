...
function exp_UMKMdanSaranaPrasarana_2rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Deskripsi')  == 'Bengkel');
    } else {
        return (feature.get('Deskripsi')  == 'Bengkel');
    }
}
...
function exp_UMKMdanSaranaPrasarana_2rule1_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Deskripsi')  == 'Kuliner');
    } else {
        return (feature.get('Deskripsi')  == 'Kuliner');
    }
}
...
function exp_UMKMdanSaranaPrasarana_2rule2_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Deskripsi')  == 'Tempat Ibadah');
    } else {
        return (feature.get('Deskripsi')  == 'Tempat Ibadah');
    }
}
...
function exp_UMKMdanSaranaPrasarana_2rule3_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Deskripsi')  == 'Penginapan');
    } else {
        return (feature.get('Deskripsi')  == 'Penginapan');
    }
}
...
function exp_UMKMdanSaranaPrasarana_2rule4_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Deskripsi')  == 'Toko Kelontong');
    } else {
        return (feature.get('Deskripsi')  == 'Toko Kelontong');
    }
}
...
function exp_UMKMdanSaranaPrasarana_2rule5_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Deskripsi')  == 'UMKM');
    } else {
        return (feature.get('Deskripsi')  == 'UMKM');
    }
}